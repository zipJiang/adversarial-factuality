    ...
    def setUp(self):
        ...
        self.test_cases = [
            ScorerInstance(
                ...
                topic="Kalki Koechlin", source_text=None),
            ScorerInstance(
                ...
                topic="Adil Rami", source_text=None),
            # ScorerInstance(
            ...
            #     topic="Song Kang", source_text=None),
            # ScorerInstance(
            ...
            #     topic="Rakhi Sawant", source_text=None
            # ),
            # ScorerInstance(
            ...
            #     topic="Sian Massey-Ellis", source_text=None
            # )
        ]
